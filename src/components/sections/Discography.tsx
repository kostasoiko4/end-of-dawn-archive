...
const Discography = () => {
  ...
  const releases = useSelector((state: RootState) => state.content.releases);
            ...
            <div className="card-gothic p-6 md:p-8">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-72 flex-shrink-0">
                  ...
                  >
                    <img 
                      src={getImage(featuredRelease.image)} 
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground font-cinzel tracking-wider mb-4">
                    {featuredRelease.type} • {featuredRelease.date} • {featuredRelease.tracks} Tracks
                  </p>
                  <p className="text-muted-foreground font-cinzel tracking-wider mb-4 text-sm">
                    Label: {featuredRelease.label}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {featuredRelease.streamLink && (
                      <a 
                        href={featuredRelease.streamLink} 
                        target="_blank"
                        rel="noopener noreferrer"
